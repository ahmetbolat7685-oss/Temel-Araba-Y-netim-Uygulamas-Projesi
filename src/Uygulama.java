...
public class Uygulama {
    ...
    public static void Calistir(Uygulama uygulama) { // geriye değer döndürmeyen bir methot tanımlandı ÖNEMLİ NOT: Maini kaldırmamda ki sebeb bir projede birden fazla main metodu olamaz yönetemeyiz main metodu olan bir classa da methot tanımlanır public sayesinde her yerden erişim sağlanır
        ...
        int secim = uygulama.scanner.nextInt();// secime sayı yazabilmek için
        uygulama.scanner.nextLine();// Eneter boşluk hatası
        ...
        // Fiyata GÖre Filitreleme
            ...
            double fiyat = uygulama.scanner.nextDouble();//  scanner nesnes
...
//                boolean bulundu = false; // boolean bulundu mu false
            ...
            String marka = uygulama.scanner.nextLine();
        ...
        } else if (secim == 4)// YENİ ARABA EKLEME
        {
            ...
            int id = uygulama.scanner.nextInt();

            uygulama.scanner.nextLine();
            System.out.print("Markasını Giriniz:");
            String marka = uygulama.scanner.nextLine();

            System.out.print("Modelini Giriniz:");
            String model = uygulama.scanner.nextLine();

            System.out.print("Yılını Girini:");
            int yil = uygulama.scanner.nextInt();

            System.out.print("Fiyatını Girini:");
            double fiyat = uygulama.scanner.nextDouble();
            ...
            double girilenFiyat = uygulama.scanner.nextInt();
